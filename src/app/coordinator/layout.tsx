...
export default async function CoordinatorLayout({ children }: LayoutProps) {
  ...
  const navItems = [
    { name: 'Event Queue', href: '/coordinator/dashboard', icon: LayoutDashboard },
  ];
      ...
      <aside className="w-64 bg-indigo-950 text-slate-100 flex flex-col justify-between border-r border-indigo-900 hidden md:flex shrink-0">
        <div className="flex flex-col">
          ...
          <div className="p-5 border-b border-indigo-900 bg-indigo-950/50">
            ...
            <p className="text-xs text-indigo-300 uppercase font-semibold tracking-wider mt-0.5">SIG / Club Coordinator</p>
