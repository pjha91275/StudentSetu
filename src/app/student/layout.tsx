        ...
        <div className="flex flex-col">
          ...
          <div className="p-6 border-b border-indigo-900 flex items-center space-x-3">
            ...
            <div>
              ...
              <span className="text-xs text-indigo-300">SIH 2026 Sandbox</span>
            </div>
          </div>
          ...
          <div className="p-5 border-b border-indigo-900 bg-indigo-950/50">
            ...
            <p className="text-xs text-indigo-300 font-mono tracking-wider truncate mt-0.5">{student.rollNumber}</p>
            <p className="text-[11px] text-indigo-400 mt-2 line-clamp-2 leading-relaxed">
              {student.program.name} ({student.department.code})
            </p>
            <div className="mt-3 flex items-center justify-between">
              <span className="text-[10px] uppercase font-bold text-indigo-400">Sem {student.currentSemester}</span>
              <span className="text-[10px] uppercase font-bold text-indigo-400">Batch {student.batch}</span>
            </div>
          </div>
